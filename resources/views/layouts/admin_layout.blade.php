...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">RSTEK CRM</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('marketings.index') }}">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Marketing</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ route('hirings.index') }}">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="{{asset('crm/img/undraw_profile.svg')}}">
                            </a>
    ...
    <script src="{{ asset('crm/vendor/jquery-easing/jquery.easing.min.js') }}"></script>

    <!-- Custom scripts for all pages-->
    <script src="{{ asset('crm/js/sb-admin-2.min.js') }}"></script>

    <!-- Page level plugins -->
    <script src="{{ asset('crm/vendor/chart.js/Chart.min.js') }}"></script>

    <!-- Page level custom scripts -->
    <script src="{{ asset('crm/js/demo/chart-area-demo.js') }}"></script>
    <script src="{{ asset('crm/js/demo/chart-pie-demo.js') }}"></script>
